          ...
          <star:ServiceAppointmentDetail>
              ...
              <star:Appointment>
                ...
                <star:AppointmentNotes>
                  <xsl:if test="string($varRoot/adf/prospect/provider/service) = 'STARLINK Service Notice'">
                    <xsl:variable name="sequence2" select="$varRoot/adf/prospect/id[@sequence='2']"/>
                    <xsl:text>STARLINK Service Code: </xsl:text>
                ...
                <!--DDC Lead Id-->
                <xsl:variable name="varTrackingCode" select="$varRoot/adf/prospect/provider/id[@source='Dealer.com']"/>
